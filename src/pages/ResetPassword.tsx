...
import { FileText, Sparkles, Lock, Eye, EyeOff, KeyRound, Loader2 } from "lucide-react";
  ...
  if (checking) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <Loader2 className="w-8 h-8 animate-spin text-electric-sapphire-500" />
      </div>
    );
  }
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center relative overflow-hidden gradient-hero">
        ...
        <div className="relative z-10 text-center p-12">
          <div className="w-32 h-32 rounded-2xl bg-gradient-to-br from-neon-pink-500 to-raspberry-plum-500 shadow-glow mx-auto mb-8 flex items-center justify-center animate-float">
        ...
        <div className="absolute top-20 left-20 w-40 h-40 bg-indigo-bloom-400/30 rounded-full blur-3xl animate-float" />
        <div className="absolute bottom-20 right-20 w-60 h-60 bg-neon-pink-400/30 rounded-full blur-3xl animate-float-delayed" />
      </div>
    </div>
  );
};

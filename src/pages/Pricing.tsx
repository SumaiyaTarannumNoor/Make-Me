        ...
        <section className="py-24 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-12">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-bloom-500/20 border border-indigo-bloom-500/30 mb-6">
                <HelpCircle className="w-4 h-4 text-indigo-bloom-600" />
                <span className="text-sm font-medium text-indigo-bloom-700">FAQ</span>
              </div>
